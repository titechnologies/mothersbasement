PlayAccountHandler = Class.create();
PlayAccountHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    initialize: function()
    {
        ...
        Validation.add('M2ePro-require-select-attribute', M2ePro.text.need_select_attributes_error, function(value, el) {
            ...
            if ($('other_listings_mapping_mode').value == PlayAccountHandlerObj.OTHER_LISTINGS_MAPPING_MODE_NO) {
                return true;
            }
        ...
        Validation.add('M2ePro-access', M2ePro.text.need_authorized_account_error, function(value, el){
