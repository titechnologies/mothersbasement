PlayListingProductSearchHandler = Class.create();
PlayListingProductSearchHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    openPopUp: function(mode, title, productId, errorMsg)
    {
        ...
        this.params = {
            ...
            size_menu: {
                width: 500,
                height: (errorMsg == undefined) ? 260 : 320
            },
            size_main: {
                width: 750,
                height: 420
        ...
        if (mode == 0) {
            ...
            new Ajax.Request(self.M2ePro.url.suggestedPlayIDGrid, {
                method: 'post',
                parameters: {
    ...
    searchGeneralIdManual: function(productId)
    {
        ...
        $('productSearch_grid').hide();
        $('productSearch_error_block').hide();
        new Ajax.Request(self.M2ePro.url.searchPlayIDManual, {
            method: 'post',
            parameters: {
                query : query,
                product_id : productId
    ...
    searchGeneralIdAuto: function(productIds)
    {
        ...
        ListingProgressBarObj.show(self.M2ePro.text.automap_play_id_progress_title);
        GridWrapperObj.lock();
    ...
    sendPartsOfProducts : function(parts,totalPartsCount)
    {
        ...
        new Ajax.Request(self.M2ePro.url.searchPlayIDAuto, {
            method: 'post',
            parameters: {
    ...
    mapToGeneralId: function(productId, generalId)
    {
        ...
        new Ajax.Request(self.M2ePro.url.mapToPlayID, {
            method: 'post',
            parameters: {
                product_id : productId,
    ...
    unmapFromGeneralId: function(productIds, afterDoneFunction)
    {
        ...
        new Ajax.Request(self.M2ePro.url.unmapFromPlayID, {
            method: 'post',
            parameters: {
    ...
    {
        var self = PlayListingProductSearchHandlerObj;
        ...
        if (selectedSku === '') {
            ...
            $('play_link_' + id).innerHTML = self.M2ePro.text.na;
