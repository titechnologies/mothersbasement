...
AmazonTemplateSynchronizationHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    relistMode_change : function()
    {
        ...
        if ($('relist_mode').value == self.RELIST_MODE_NONE) {
            ...
            $('magento_block_amazon_template_synchronization_relist_schedule').hide();
            ...
            $('magento_block_amazon_template_synchronization_relist_schedule').show();
        } else {
            $('relist_filter_user_lock_tr_container').hide();
            $('magento_block_amazon_template_synchronization_relist_rules').hide();
            $('magento_block_amazon_template_synchronization_relist_schedule').hide();
