...
class Ess_M2ePro_Block_Adminhtml_Play_Order_Edit_ShippingAddress_Form extends Mage_Adminhtml_Block_Widget_Form
{
    private $order;
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/play/order/edit/shipping_address.phtml');
