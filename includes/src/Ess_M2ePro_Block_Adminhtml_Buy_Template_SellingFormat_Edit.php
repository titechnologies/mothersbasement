...
class Ess_M2ePro_Block_Adminhtml_Buy_Template_SellingFormat_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_buy_template_sellingFormat';
        $this->_mode = 'edit';
        //------------------------------
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'BuyTemplateSellingFormatHandlerObj.back_click(\''
        ...
        if (Mage::helper('M2ePro')->getGlobalValue('temp_data')
            ...
            $this->_addButton('duplicate', array(
                ...
                'onclick' => 'BuyTemplateSellingFormatHandlerObj.duplicate_click(\'buy-template-sellingFormat\')',
