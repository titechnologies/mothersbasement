 ...
 */
class TBT_Rewards_Model_Tag_Reason extends TBT_Rewards_Model_Transfer_Reason_Abstract {
	const REASON_TYPE_ID = 32;
	...
	public function getDistributionReasons() {
		return array(self::REASON_TYPE_ID => Mage::helper ('rewards')->__('Customer tagged a product'));
	}
