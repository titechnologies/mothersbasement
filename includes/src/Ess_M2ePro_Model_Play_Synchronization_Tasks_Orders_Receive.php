...
class Ess_M2ePro_Model_Play_Synchronization_Tasks_Orders_Receive extends Ess_M2ePro_Model_Play_Synchronization_Tasks
{
    ...
    private $config = NULL;
    private $configGroup = '/play/synchronization/settings/orders/receive/';
    ...
    private function processAccountMarketplace(
        ...
        $status = 'Task "Orders Synchronization" for %s "%s" Account and "%s" marketplace is started. Please wait...';
        $status = Mage::helper('M2ePro')->__($status, 'Play.com', $account->getTitle(), $marketplace->getTitle());
