...
class Ess_M2ePro_Block_Adminhtml_Amazon_Template_NewProduct_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general', array(
            ...
            'content' => $this->getLayout()->createBlock(
                'M2ePro/adminhtml_amazon_template_newProduct_edit_tabs_general'
            )->toHtml(),
        ));
        ...
        $this->addTab('description', array(
            ...
            'content' => $this->getLayout()->createBlock(
                'M2ePro/adminhtml_amazon_template_newProduct_edit_tabs_description'
            )->toHtml(),
        ));
        ...
        $this->addTab('specifics', array(
            ...
            'content' => $this->getLayout()->createBlock(
                'M2ePro/adminhtml_amazon_template_newProduct_edit_tabs_specifics'
            )->toHtml(),
        ));
