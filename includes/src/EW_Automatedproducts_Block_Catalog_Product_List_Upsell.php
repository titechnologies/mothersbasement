<?php
class EW_Automatedproducts_Block_Catalog_Product_List_Upsell extends Mage_Catalog_Block_Product_List_Upsell
{
	protected function _prepareData()
	{
		$helper = Mage::helper('automatedproducts');
		$config = $helper->getConfig("automatedproducts/upsellproducts");
		$conditions = $helper->getConditions("upsellproducts");
		//if($helper->isEnabled('upsellproducts')) {
