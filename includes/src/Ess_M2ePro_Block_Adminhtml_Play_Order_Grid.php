...
class Ess_M2ePro_Block_Adminhtml_Play_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status', array(
            ...
            'type'    => 'options',
            'options' => array(
                Ess_M2ePro_Model_Play_Order::STATUS_PENDING  => $helper->__('Pending'),
                Ess_M2ePro_Model_Play_Order::STATUS_SOLD     => $helper->__('Sold'),
                Ess_M2ePro_Model_Play_Order::STATUS_POSTED   => $helper->__('Posted'),
                Ess_M2ePro_Model_Play_Order::STATUS_CANCELED => $helper->__('Canceled')
            ),
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url'     => array('base' => '*/adminhtml_play_order/view'),
                    'field'   => 'id'
                ),
                array(
                    'caption' => Mage::helper('M2ePro')->__('Edit Shipping Address'),
                    'url'     => array('base' => '*/adminhtml_play_order/editShippingAddress/back/'.$back.'/'),
                    'field'   => 'id'
                ),
                array(
                    'caption' => Mage::helper('M2ePro')->__('Create Order'),
                    'url'     => array('base' => '*/adminhtml_play_order/createMagentoOrder'),
                    'field'   => 'id'
                ),
                array(
                    'caption' => Mage::helper('M2ePro')->__('Mark As Shipped'),
                    'url'     => array('base' => '*/adminhtml_play_order/updateShippingStatus'),
                    'field'   => 'id'
                )
            ),
            'filter'    => false,
...
HTML;
    ...
    {
        return $this->getUrl('*/adminhtml_play_order/grid', array('_current' => true));
    }
    ...
    public function getRowUrl($row)
    {
        ...
        return $this->getUrl('*/adminhtml_play_order/view', array('id' => $row->getId(), 'back' => $back));
    }
