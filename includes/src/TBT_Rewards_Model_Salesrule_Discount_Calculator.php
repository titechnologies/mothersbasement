...
class TBT_Rewards_Model_Salesrule_Discount_Calculator extends Mage_SalesRule_Model_Validator {
	...
	public function getNewDiscounts($quote, $address, $item, $rule_id) {
		...
		//@nelkaake -a 11/03/11: Make sure the discount percent is 100% max.
		...
		switch ($rule->getPointsDiscountAction ()) {
			...
			default:
				throw new Exception("Reached unsupported discount action. This may be due to corrupt data.  Unexpected rule action was: ". $rule->getPointsDiscountAction ());
				break;
		}
