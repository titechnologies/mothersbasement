...
class Ess_M2ePro_Block_Adminhtml_Play_Account_Edit_Tabs_Order extends Mage_Adminhtml_Block_Widget
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/play/account/tabs/order.phtml');
    }
