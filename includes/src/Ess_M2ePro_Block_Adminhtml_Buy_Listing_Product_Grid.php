...
class Ess_M2ePro_Block_Adminhtml_Buy_Listing_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('attributes', array(
            'label' => '&nbsp;&nbsp;&nbsp;&nbsp;',
            'url'   => $this->getUrl('*/adminhtml_buy_listing/massStatus', array('_current'=>true)),
        ));
        //--------------------------------
    ...
    {
        return $this->getUrl('*/adminhtml_buy_listing/productGrid', array('_current'=>true));
    }
...
STYLE;
        ...
        $createListingUrl = $this->getUrl(
            '*/adminhtml_buy_listing/createListing'
        );
        $getProductsUrl = $this->getUrl(
            '*/adminhtml_buy_listing/getProductsFromCategories'
        );
        $addProductsUrl = $this->getUrl(
            '*/adminhtml_buy_listing/addProducts'
        );
