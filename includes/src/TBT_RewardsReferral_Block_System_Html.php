 ...
 */
class TBT_RewardsReferral_Block_System_Html extends Mage_Adminhtml_Block_System_Config_Form_Fieldset {
    ...
    public function render(Varien_Data_Form_Element_Abstract $element) {
        ...
        $html .= "
            ...
            Sweet Tooth Referral/Affiliate Extension v" . Mage::getConfig()->getNode('modules/TBT_RewardsReferral/version') .
