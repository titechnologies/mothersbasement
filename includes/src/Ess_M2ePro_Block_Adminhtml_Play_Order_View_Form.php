...
class Ess_M2ePro_Block_Adminhtml_Play_Order_View_Form extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/play/order.phtml');
        //------------------------------
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->setChild('item', $this->getLayout()->createBlock('M2ePro/adminhtml_play_order_view_item'));
