 ...
 */
class TBT_Rewardssocial_Model_Referral_Share_Reason extends TBT_Rewards_Model_Transfer_Reason_Abstract
{
    const REASON_TYPE_ID = 35;
    ...
    public function getDistributionReasons() {
        return array(self::REASON_TYPE_ID => $this->_getHelper()->__('Customer shared their referral link'));
    }
    ...
    protected function _getHelper() {
        return Mage::helper('rewardssocial');
    }
