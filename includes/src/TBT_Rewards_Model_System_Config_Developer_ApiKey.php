...
/**
 * Used to save the Developer/ApiKey field on the Config page to its non-default config path
 * @category   TBT
 * @package    TBT_Rewards
 * @author     Sweet Tooth Team <contact@sweettoothhq.com>
 */
class TBT_Rewards_Model_System_Config_Developer_ApiKey extends Mage_Core_Model_Config_Data
{
    /**
     * Save the API Key to its (custom) config path and set the Platform account
     * as Connected if API Key is not blank
     * @return self
     */
    public function save()
    {
        ...
        Mage::getModel('core/config')->saveConfig('rewards/platform/apikey', $this->getValue());
