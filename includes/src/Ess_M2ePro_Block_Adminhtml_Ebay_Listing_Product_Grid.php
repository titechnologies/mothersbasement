...
<script type="text/javascript">
    ...
    var init = function () {
        ebayListingProductGrid{$suffixGridId}JsObject.doFilter = ProductGridHandlerObj.setFilter;
        ebayListingProductGrid{$suffixGridId}JsObject.resetFilter = ProductGridHandlerObj.resetFilter;
        if ({$isShowRuleBlock}) {
