        ...
        $content.= '<style>
                    ...
                    <div class="developer">
                            <a href="http://www.magazento.com/english/magento-ext/magazento-extensions/navigation-menu-megamenu"
                                    target="_blank"><img
                                    src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'frontend/base/default/magazento/easytopseller/menu_box.jpg"
                                    >
                            </a>
                    ...
                    <div class="developer">
                            <a href="http://www.magazento.com/english/magento-ext/magazento-extensions/magento-one-step-page-checkout"
                                    target="_blank"><img
                                    src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'frontend/base/default/magazento/easytopseller/logo_onecheckout.jpg"
                                    >
                            </a>
                    ...
                    <div class="developer">
                            <a href="http://www.magazento.com/english/magento-ext/magazento-extensions/pdf-export"
                                    target="_blank"><img
                                    src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'frontend/base/default/magazento/easytopseller/logo_pdf.jpg"
                                    >
                            </a>
                    ...
                    <div class="developer">
                            <a href="http://www.magazento.com/english/magento-ext/magazento-extensions/extension-html-sitemap"
                                    target="_blank"><img
                                    src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'frontend/base/default/magazento/easytopseller/logo_sitemap.jpg"
                                    >
                            </a>
