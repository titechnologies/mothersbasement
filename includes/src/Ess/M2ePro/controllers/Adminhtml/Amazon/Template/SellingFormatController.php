    ...
    extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function saveAction()
    {
        ...
        ($data['qty_mode'] == Ess_M2ePro_Model_Amazon_Template_SellingFormat::QTY_MODE_SINGLE ||
         $data['qty_mode'] == Ess_M2ePro_Model_Amazon_Template_SellingFormat::QTY_MODE_NUMBER ||
         $data['qty_max_posted_value_mode'] ==
             Ess_M2ePro_Model_Amazon_Template_SellingFormat::QTY_MAX_POSTED_MODE_OFF) &&
