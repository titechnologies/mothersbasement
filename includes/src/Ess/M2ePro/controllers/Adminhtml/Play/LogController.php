...
class Ess_M2ePro_Adminhtml_Play_LogController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function listingOtherGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()
            ->createBlock('M2ePro/adminhtml_play_listing_other_log_grid')->toHtml();
