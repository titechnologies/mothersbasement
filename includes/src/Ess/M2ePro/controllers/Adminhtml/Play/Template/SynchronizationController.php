...
class Ess_M2ePro_Adminhtml_Play_Template_SynchronizationController
    extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    protected function _initAction()
    {
        ...
        $this->getLayout()->getBlock('head')
            ->addJs('M2ePro/Play/Template/SynchronizationHandler.js');
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_play_template_synchronization_edit'))
            ->_addLeft($this->getLayout()->createBlock('M2ePro/adminhtml_play_template_synchronization_edit_tabs'))
            ->renderLayout();
    }
    ...
    public function saveAction()
    {
        ...
        ($data['revise_update_qty'] ==
            Ess_M2ePro_Model_Play_Template_Synchronization::REVISE_MAX_AFFECTED_QTY_MODE_OFF ||
        ...
        $temp = Ess_M2ePro_Model_Play_Template_Synchronization::RELIST_SCHEDULE_TYPE_WEEK;
