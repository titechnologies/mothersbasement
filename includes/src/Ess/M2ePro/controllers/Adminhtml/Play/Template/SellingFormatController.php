...
class Ess_M2ePro_Adminhtml_Play_Template_SellingFormatController
    extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    protected function _initAction()
    {
        ...
        $this->getLayout()->getBlock('head')
            ...
            ->addJs('M2ePro/Play/Template/SellingFormatHandler.js');
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_play_template_sellingFormat_edit'))
            ->renderLayout();
    }
    ...
    public function saveAction()
    {
        ...
        ($data['qty_mode'] == Ess_M2ePro_Model_Play_Template_SellingFormat::QTY_MODE_SINGLE ||
            $data['qty_mode'] == Ess_M2ePro_Model_Play_Template_SellingFormat::QTY_MODE_NUMBER ||
            $data['qty_max_posted_value_mode']== Ess_M2ePro_Model_Play_Template_SellingFormat::QTY_MAX_POSTED_MODE_OFF) &&
        ...
        // Add or update model
        //--------------------
        $model = Mage::helper('M2ePro/Component_Play')->getModel('Template_SellingFormat');
