...
class Ess_M2ePro_Adminhtml_Buy_OrderController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    {
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_buy_order_grid')->toHtml();
    ...
    public function viewAction()
    {
        ...
        $this->_initAction();
        $this->_initPopUp();
        $this->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_buy_order_view'))
             ->renderLayout();
    }
    ...
    public function orderItemGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_buy_order_view_item')->toHtml();
        $this->getResponse()->setBody($response);
    }
    ...
    public function createMagentoOrderAction()
    {
        ...
        if (!is_null($order->getMagentoOrderId()) && $force != 'yes') {
            ...
            $this->_getSession()->addWarning(Mage::helper('M2ePro')->__(
                $message, Mage::helper('M2ePro')->__(Ess_M2ePro_Helper_Component_Buy::NICK)
            ));
    ...
    public function editShippingAddressAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_buy_order_edit_shippingAddress'))
             ->renderLayout();
    }
    ...
    public function saveShippingAddressAction()
    {
        ...
        $this->_redirect('*/adminhtml_buy_order/view', array('id' => $order->getId()));
    }
