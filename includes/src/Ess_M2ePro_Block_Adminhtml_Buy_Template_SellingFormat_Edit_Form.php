...
class Ess_M2ePro_Block_Adminhtml_Buy_Template_SellingFormat_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/buy/template/selling_format/form.phtml');
    }
