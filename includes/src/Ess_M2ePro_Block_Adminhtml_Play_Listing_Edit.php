...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'PlayListingSettingsHandlerObj.back_click(\''.Mage::helper('M2ePro')
        ...
        $this->_addButton('save', array(
            ...
            'onclick'   => 'PlayListingSettingsHandlerObj.save_click(\''
                .$this->getUrl('*/adminhtml_play_listing/save',
