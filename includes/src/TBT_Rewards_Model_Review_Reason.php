 ...
 */
class TBT_Rewards_Model_Review_Reason extends TBT_Rewards_Model_Transfer_Reason_Abstract {
	const REASON_TYPE_ID = 31;
	...
	public function getDistributionReasons() {
		return array(self::REASON_TYPE_ID => Mage::helper ( 'rewards' )->__('Customer wrote a review'));
	}
