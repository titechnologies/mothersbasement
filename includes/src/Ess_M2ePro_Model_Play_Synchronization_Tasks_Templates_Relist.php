    ...
    extends Ess_M2ePro_Model_Play_Synchronization_Tasks_Templates_Abstract
{
    ...
    {
        $this->immediatelyChangePlayStatus();
    ...
    private function immediatelyChangePlayStatus()
    {
        $this->_profiler->addTimePoint(__METHOD__,'Immediately when Play.com status inactive');

        // Get changed listings products
        //------------------------------------
        $changedListingsProducts = $this->getChangedInstancesByListingProduct(
            array('play_listing_product_status')
        );
        //------------------------------------
