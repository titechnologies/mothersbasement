...
class Ess_M2ePro_Block_Adminhtml_Buy_Listing_View_Grid extends Ess_M2ePro_Block_Adminhtml_Listing_View_Grid
{
...
HTML;
        ...
        if (!empty($templateNewProductId)) {
            ...
            $newSkuTemplateUrl = $this->getUrl(
                '*/adminhtml_buy_template_newProduct/edit/',
                array(
                    'id' => $templateNewProductId,
                    'listing_product_id' => $lpId,
                    'save_and_assign' => 0,
                    'back' => Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_buy_listing/view',array(
...
<a href="javascript:;" title="{$tip}"
   onclick="BuyListingProductSearchHandlerObj.showUnmapFromGeneralIdPrompt('{$lpId}');">
