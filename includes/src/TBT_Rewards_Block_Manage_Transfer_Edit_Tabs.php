...
class TBT_Rewards_Block_Manage_Transfer_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml() {
		$this->addTab ( 'form_section', array ('label' => Mage::helper ( 'rewards' )->__ ( 'Transfer Information' ), 'title' => Mage::helper ( 'rewards' )->__ ( 'Transfer Information' ), 'content' => $this->getLayout ()->createBlock ( 'rewards/manage_transfer_edit_tab_form' )->toHtml (), 'active' => true ) );
