...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    // ####################################
...
//                             '(csi.product_id = `main_table`.product_id)',array('qty'))
    ...
    public function callbackColumnProductTitle($value, $row, $column, $isExport)
    {
        ...
        $urlParams['back'] = Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_play_listing/search');

        $listingUrl = $this->getUrl('*/adminhtml_play_listing/view',$urlParams);
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $url = $this->getUrl('*/adminhtml_play_listing/view/', array(
...
HTML;
    ...
    {
        return $this->getUrl('*/adminhtml_play_listing/searchGrid', array('_current'=>true));
    }
