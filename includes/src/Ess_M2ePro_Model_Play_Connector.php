...
class Ess_M2ePro_Model_Play_Connector
{
    ...
    {
        $dispatcherObject = Mage::getModel('M2ePro/Play_Connector_Product_Dispatcher');
    ...
    {
        $componentNick = Ess_M2ePro_Helper_Component_Play::NICK;
