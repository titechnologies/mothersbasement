 ...
 */
class TBT_RewardsReferral_Model_Manage_Diagnostics extends Mage_Core_Model_Abstract
{
    const CORE_RESOURCE_CODE = 'rewardsref_setup';
    ...
    public function reinstalldb() {
        $code = TBT_RewardsReferral_Model_Manage_Diagnostics::CORE_RESOURCE_CODE;
    	echo "<br>Deleting core_resource table entries that have the code '{$code}'...";
    	flush();
