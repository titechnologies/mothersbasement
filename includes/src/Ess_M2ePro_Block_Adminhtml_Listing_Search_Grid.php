...
class Ess_M2ePro_Block_Adminhtml_Listing_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        if (count(Mage::helper('M2ePro/Component')->getActiveComponents()) > 1) {
            $playTitle = Mage::helper('M2ePro')->__(Ess_M2ePro_Helper_Component_Play::TITLE);

            $options = Mage::helper('M2ePro/Component')->getEnabledComponentsTitles();
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $url = $this->getUrl('*/adminhtml_'.$row->getData('component_mode').'_listing/view/',array(
