                                                    ...
                                                    $ebayChange)
    {
        ...
        if ($tempEbayChanges['status'] != $tempListingProductModel->getStatus()) {
            ...
            Mage::getModel('M2ePro/ProductChange')->updateAttribute(
               $tempListingProductModel->getProductId(), 'ebay_listing_product_status',
               'listing_product_id_'.$tempListingProductModel->getId().'_status_'.$tempListingProductModel->getStatus(),
               'listing_product_id_'.$tempListingProductModel->getId().'_status_'.$tempEbayChanges['status'],
