...
class Ess_M2ePro_Block_Adminhtml_Buy_Template_NewProduct_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $back = Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_buy_template_newProduct');
        ...
        $this->addColumn('actions', array(
            ...
            'actions'   => array(
                array(
                    ...
                    'url'       => array('base'=> '*/adminhtml_buy_template_newProduct/edit/back/'.$back),
                    'field'     => 'id'
                ),
                array(
                    'caption'   => Mage::helper('M2ePro')->__('Delete Template'),
                    'url'       => array('base'=> '*/adminhtml_buy_template_newProduct/delete/back/'
    ...
    {
        $url = $this->getUrl(
            '*/adminhtml_buy_template_newProduct/map/',
            array(
                'id' => $row->getId(),
            )
        );
...
JAVASCRIPT;
    ...
    {
        return $this->getUrl('*/adminhtml_buy_template_newProduct/templateNewProductGrid', array('_current'=>true));
    }
    ...
    public function getRowUrl($row)
    {
        ...
        return $this->getUrl('*/adminhtml_buy_template_newProduct/edit', array(
            'id' => $row->getId(),
            'back' => $back
        ));
    }
