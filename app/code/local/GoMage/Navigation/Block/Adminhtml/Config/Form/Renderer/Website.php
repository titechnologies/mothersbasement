...
class GoMage_Navigation_Block_Adminhtml_Config_Form_Renderer_Website extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
    	...
    	//echo Mage::helper('core')->decrypt($element->getValue())."---------";
    	//echo str_replace($r, '', Mage::helper('core')->decrypt($element->getValue()));
        ...
        $html .= '
        	<input id="'.$idprefix.'_diasbled" type="hidden" name="'.$nameprefix.'" />
