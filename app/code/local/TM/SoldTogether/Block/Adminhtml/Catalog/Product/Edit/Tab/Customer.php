...
//        }
        ...
        $this->addColumn('soldtogehter_weight', array(
            'header'            => Mage::helper('catalog')->__('Weight'),
            'name'              => 'soldtogehter_weight',
            'type'              => 'number',
            'validate_class'    => 'validate-number',
            'index'             => 'soldtogehter_weight',
            'width'             => 60,
    ...
    public function getSelectedRelatedProducts()
    {
        ...
        foreach ($model->getRelated(Mage::registry('current_product')->getId()) as $values) {
            $products[$values['related_product_id']] = array('soldtogehter_weight' => $values['weight']);
        }
        return $products;
    }
}
