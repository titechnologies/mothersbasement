...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(array('sfo'=>'sales_flat_order'), 'main_table.entity_id=sfo.entity_id', array('sfo.customer_email'));
        $collection->addFilterToMap('status_preorder', 'main_table.status_preorder');
