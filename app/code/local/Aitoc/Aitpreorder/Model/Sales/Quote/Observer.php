 ...
 * File path:   app/code/local/Aitoc/Aitpreorder/Model/Sales/Quote/Observer.php
 * Copyright:   (c) 2012 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpreorder')){ UgcjIPYiBZqTrDBy('b1b7415a0cbfac704e0ed2be9a4adc16'); ?><?php
class Aitoc_Aitpreorder_Model_Sales_Quote_Observer extends Mage_Core_Model_Abstract
{
