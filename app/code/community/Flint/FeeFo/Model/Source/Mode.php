...
class Flint_FeeFo_Model_Source_Mode
{
    ...
    public function toOptionArray()
    {
        if (!$this->_options) {            
		  ...
		  array('value' => 'service', 'label' => Mage::helper('flint_feefo')->__('Service Only Commets')),
		  array('value' => 'product', 'label' => Mage::helper('flint_feefo')->__('Product Only Commets')),
		  array('value' => 'both', 'label' => Mage::helper('flint_feefo')->__('Service and Product Commets')),
