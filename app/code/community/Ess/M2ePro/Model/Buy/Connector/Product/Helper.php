...
class Ess_M2ePro_Model_Buy_Connector_Product_Helper
{
    // ########################################
    ...
    public function getListRequestData(Ess_M2ePro_Model_Listing_Product $listingProduct, array $params = array())
    {
        ...
        if (empty($requestData['product_id'])) {
            ...
            $requestData['product_id_type']=$listingProduct->getGeneralTemplate()->getChildObject()->getGeneralIdMode();
                                          ...
                                          array $nativeRequestData = array(), array $params = array())
    {
        ...
        if (($nativeRequestData['product_id_type']+1) ==
            Ess_M2ePro_Model_Buy_Template_General::GENERAL_ID_MODE_GENERAL_ID) {
                                          ...
                                          array $nativeRequestData = array(), array $params = array())
    {
        ...
        $dataForUpdate = array(
            ...
            'online_qty' => 0,
            'ignore_next_inventory_synch' => Ess_M2ePro_Model_Buy_Listing_Product::IGNORE_NEXT_INVENTORY_SYNCH_YES
        );
