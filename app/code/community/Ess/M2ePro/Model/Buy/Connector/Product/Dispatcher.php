...
class Ess_M2ePro_Model_Buy_Connector_Product_Dispatcher
{
    const ACTION_LIST    = 1;
    ...
    private $connectorMode = Ess_M2ePro_Model_Buy_Connector::MODE_SERVER;
        ...
        if ($action == self::ACTION_LIST) {
            ...
            if (count($listProducts) > 0) {
                ...
                $results[] = $this->processGroupedProducts($sortedProductsListData,
                                                           ...
                                                           'Ess_M2ePro_Model_Connector_'
                                                               .ucfirst($this->getConnectorMode())
                                                               .'_Buy_Product_List_Multiple',
                                                           $params);
            }

            if (count($results) <= 0) {
                $results[] = Ess_M2ePro_Model_Buy_Connector_Product_Requester::STATUS_ERROR;
            }

            return Ess_M2ePro_Model_Buy_Connector_Product_Requester::getMainStatus($results);
        }

        $result = Ess_M2ePro_Model_Buy_Connector_Product_Requester::STATUS_ERROR;
    ...
    protected function processProducts(array $products, $connectorName, array $params = array())
    {
        try {
            ...
            return Ess_M2ePro_Model_Buy_Connector_Product_Requester::STATUS_ERROR;
        }
    }
