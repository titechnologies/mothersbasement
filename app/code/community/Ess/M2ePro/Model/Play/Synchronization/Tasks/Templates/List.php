    ...
    extends Ess_M2ePro_Model_Play_Synchronization_Tasks_Templates_Abstract
{
    ...
    private function immediatelyNotCheckedProducts()
    {
        ...
        $collection->addFieldToFilter('tried_to_list',Ess_M2ePro_Model_Play_Listing_Product::TRIED_TO_LIST_NO);
        ...
        foreach ($listingsProducts as $listingProduct) {
            ...
            $listingProduct->setData('tried_to_list',Ess_M2ePro_Model_Play_Listing_Product::TRIED_TO_LIST_YES)
                           ->save();
