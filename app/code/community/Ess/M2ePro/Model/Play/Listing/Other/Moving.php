...
class Ess_M2ePro_Model_Play_Listing_Other_Moving
{
    ...
    protected function createDefaultGeneralTemplate(Ess_M2ePro_Model_Listing_Other $otherListing)
    {
        ...
        $tempModel = Mage::helper('M2ePro/Component_Play')->getModel('Template_General');

        $dataForAdd = array(
            'title' => 'Default ('.$this->getAccount()->getTitle().')',
            'marketplace_id' => $marketplaceId,
            'account_id' => $accountId,
            'sku_mode' => Ess_M2ePro_Model_Play_Template_General::SKU_MODE_NOT_SET,
            'general_id_mode' => Ess_M2ePro_Model_Play_Template_General::GENERAL_ID_MODE_NOT_SET,
            'search_by_magento_title_mode' =>
                Ess_M2ePro_Model_Play_Template_General::SEARCH_BY_MAGENTO_TITLE_MODE_YES,

            'dispatch_to_mode' => Ess_M2ePro_Model_Play_Template_General::DISPATCH_TO_MODE_NOT_SET,
            'dispatch_from_mode' => Ess_M2ePro_Model_Play_Template_General::DISPATCH_FROM_MODE_NOT_SET,

            'condition_mode' => Ess_M2ePro_Model_Play_Template_General::CONDITION_MODE_NOT_SET,
            'condition_note_mode' => Ess_M2ePro_Model_Play_Template_General::CONDITION_NOTE_MODE_NOT_SET,

            'shipping_price_gbr_mode' =>
                                    Ess_M2ePro_Model_Play_Template_General::SHIPPING_PRICE_GBR_MODE_NONE,
            'shipping_price_euro_mode' =>
                                    Ess_M2ePro_Model_Play_Template_General::SHIPPING_PRICE_EURO_MODE_NONE
        );
    ...
    protected function getDefaultSynchronizationTemplate(Ess_M2ePro_Model_Listing_Other $otherListing)
    {
        ...
        $dataForAdd = array(
            ...
            'relist_schedule_type'=>Ess_M2ePro_Model_Play_Template_Synchronization::RELIST_SCHEDULE_TYPE_IMMEDIATELY,
            'relist_schedule_through_value' => 0,
            'relist_schedule_through_metric' =>
                                Ess_M2ePro_Model_Play_Template_Synchronization::RELIST_SCHEDULE_THROUGH_METRIC_DAYS,
    ...
    protected function getDefaultDescriptionTemplate(Ess_M2ePro_Model_Listing_Other $otherListing)
    {
        ...
        $tempCollection = Mage::helper('M2ePro/Component_Play')->getCollection('Template_Description');
        $tempCollection->addFieldToFilter('main_table.title','Default');
        $tempItem = $tempCollection->getFirstItem();
        ...
        $tempModel = Mage::helper('M2ePro/Component_Play')->getModel('Template_Description');
