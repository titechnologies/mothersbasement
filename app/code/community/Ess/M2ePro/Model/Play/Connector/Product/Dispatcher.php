...
class Ess_M2ePro_Model_Play_Connector_Product_Dispatcher
{
    const ACTION_LIST    = 1;
    ...
    private $connectorMode = Ess_M2ePro_Model_Play_Connector::MODE_SERVER;
    ...
    {
        $result = Ess_M2ePro_Model_Play_Connector_Product_Requester::STATUS_ERROR;
    ...
    protected function processProducts(array $products, $connectorName, array $params = array())
    {
        try {
            ...
            return Ess_M2ePro_Model_Play_Connector_Product_Requester::STATUS_ERROR;
        }
    }
