...
class Ess_M2ePro_Model_Play_Connector_Product_Helper
{
    // ########################################
    ...
    public function getReviseRequestData(Ess_M2ePro_Model_Listing_Product $listingProduct, array $params = array())
    {
        ...
        if ($permissions['price']) {
            ...
            $requestData['price_gbr'] = $listingProduct->getChildObject()->getPriceGbr();
            $requestData['price_euro'] = $listingProduct->getChildObject()->getPriceEuro();
                                          ...
                                          array $nativeRequestData = array(), array $params = array())
    {
        ...
        $dataForUpdate = array(
            ...
            'online_qty' => 0,
            'ignore_next_inventory_synch' => Ess_M2ePro_Model_Play_Listing_Product::IGNORE_NEXT_INVENTORY_SYNCH_YES
        );
