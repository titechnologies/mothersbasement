...
class Ess_M2ePro_Adminhtml_Play_OrderController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    {
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_play_order_grid')->toHtml();
    ...
    public function viewAction()
    {
        ...
        $this->_initAction();
        $this->_initPopUp();
        $this->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_play_order_view'))
             ->renderLayout();
    }
    ...
    public function orderItemGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_play_order_view_item')->toHtml();
        $this->getResponse()->setBody($response);
    }
    ...
    public function orderLogGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_play_order_view_log')->toHtml();
        $this->getResponse()->setBody($response);
    }
    ...
    public function createMagentoOrderAction()
    {
        ...
        if (!is_null($order->getMagentoOrderId()) && $force != 'yes') {
            ...
            $this->_getSession()->addWarning(Mage::helper('M2ePro')->__(
                $message, Mage::helper('M2ePro')->__(Ess_M2ePro_Helper_Component_Play::NICK)
            ));
    ...
    public function editShippingAddressAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_play_order_edit_shippingAddress'))
             ->renderLayout();
    }
    ...
    public function saveShippingAddressAction()
    {
        ...
        $this->_redirect('*/adminhtml_play_order/view', array('id' => $order->getId()));
    }
