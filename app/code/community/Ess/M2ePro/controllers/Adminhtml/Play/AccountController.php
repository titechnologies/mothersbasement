...
class Ess_M2ePro_Adminhtml_Play_AccountController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    protected function _initAction()
    {
        ...
        $this->getLayout()->getBlock('head')
            ...
            ->addJs('M2ePro/Play/AccountHandler.js');
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_play_account_edit'))
            ->_addLeft($this->getLayout()->createBlock('M2ePro/adminhtml_play_account_edit_tabs'))
            ->renderLayout();
    }
