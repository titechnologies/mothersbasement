...
class Ess_M2ePro_Adminhtml_Buy_Template_NewProductController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    {
        parent::preDispatch();
        $this->listingProductIds = Mage::helper('M2ePro')->getSessionValue('buy_listing_product_ids');
    }
    ...
    private function saveListingProductIds()
    {
        ...
        Mage::helper('M2ePro')->setSessionValue('buy_listing_product_ids',$listingProductIds);
        $this->listingProductIds = Mage::helper('M2ePro')->getSessionValue('buy_listing_product_ids');
    }
