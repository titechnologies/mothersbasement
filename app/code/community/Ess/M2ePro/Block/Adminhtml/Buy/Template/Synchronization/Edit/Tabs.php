...
class Ess_M2ePro_Block_Adminhtml_Buy_Template_Synchronization_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('list', array(
            ...
            'content' => $this->getLayout()
                ->createBlock('M2ePro/adminhtml_buy_template_synchronization_edit_tabs_list')
                ->toHtml(),
        ))
            ->addTab('revise', array(
            ...
            'content' => $this->getLayout()
                ->createBlock('M2ePro/adminhtml_buy_template_synchronization_edit_tabs_revise')
                ->toHtml(),
        ))
            ->addTab('relist', array(
            ...
            'content' => $this->getLayout()
                ->createBlock('M2ePro/adminhtml_buy_template_synchronization_edit_tabs_relist')
                ->toHtml(),
        ))
            ->addTab('stop', array(
            ...
            'content' => $this->getLayout()
                ->createBlock('M2ePro/adminhtml_buy_template_synchronization_edit_tabs_stop')
                ->toHtml(),
        ))
