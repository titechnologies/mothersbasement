...
class Ess_M2ePro_Block_Adminhtml_Buy_Listing_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    // ####################################
...
//                             '(csi.product_id = `main_table`.product_id)',array('qty'))
    ...
    public function callbackColumnProductTitle($value, $row, $column, $isExport)
    {
        ...
        $urlParams['back'] = Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_buy_listing/search');

        $listingUrl = $this->getUrl('*/adminhtml_buy_listing/view',$urlParams);
...
HTML;
    ...
    {
        return $this->getUrl('*/adminhtml_buy_listing/searchGrid', array('_current'=>true));
    }
