...
class Ess_M2ePro_Block_Adminhtml_Buy_Listing_Product extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        if (is_null($this->getRequest()->getParam('back'))) {
            $backUrl = $this->getUrl('*/adminhtml_buy_listing/categoryProduct',array(
                'id' => $listingData['id'],
        ...
        //$tempUrl = $this->getUrl('*/adminhtml_buy_listing/product',array(
        //    'id' => $listingData['id'],
