...
class Ess_M2ePro_Block_Adminhtml_Buy_Listing_Search extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    // ########################################
    ...
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_buy_listing_search';
        //------------------------------
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'CommonHandlerObj.back_click(\''
                    .Mage::helper('M2ePro')->getBackUrl('*/adminhtml_buy_listing/search').'\')',
                'class'     => 'back'
            ));
        }
                ...
                .$this->getUrl('*/adminhtml_listing/index',
                    array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_BUY,
                        'back'=> Mage::helper('M2ePro')
                            ->makeBackUrlParam('*/adminhtml_buy_listing/search')))
                .'\')',
            'class'     => 'button_link'
        ));
