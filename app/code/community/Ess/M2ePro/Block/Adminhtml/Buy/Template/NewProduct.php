...
class Ess_M2ePro_Block_Adminhtml_Buy_Template_NewProduct extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $url = $this->getUrl('*/adminhtml_buy_listing/view',array(
            'id' => $listingId
        ));
        ...
        $tempUrl = $this->getUrl('*/adminhtml_buy_template_newProduct/add',array(
    ...
    {
        $helpBlock = $this->getLayout()->createBlock('M2ePro/adminhtml_buy_template_newProduct_help');
