...
class Ess_M2ePro_Block_Adminhtml_Play_Listing extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    // ####################################
    ...
    public function __construct()
    {
        ...
        $this->_addButton('search_play_products', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_play_listing/search',
                array('back' => Mage::helper('M2ePro')->
                    makeBackUrlParam('*/adminhtml_listing/index',
                    array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_PLAY)))).'\')',
        ...
        $this->_addButton('add', array(
            ...
            'onclick'   => 'setLocation(\'' .$this->getUrl('*/adminhtml_play_listing/add',
...
$$('.play-templates-drop-down')[0].innerHTML += '{$tempDropDownHtml}';
DropDownObj = new DropDown();
DropDownObj.prepare($$('.play-templates-drop-down')[0]);
JAVASCRIPT;
...
JAVASCRIPT;
    ...
    protected function getTemplatesButtonDropDownHtml()
    {
        ...
        $sellingFormatUrl = $this->getUrl('*/adminhtml_template_sellingFormat/index',
            array('filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Play::NICK)));
