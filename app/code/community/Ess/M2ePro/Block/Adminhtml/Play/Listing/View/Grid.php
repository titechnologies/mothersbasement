...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_View_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
...
<a href="javascript:;" title="{$tip}"
    onclick="PlayListingProductSearchHandlerObj.openPopUp(0,'{$productTitle}',{$lpId},'{$tip}');">
...
N/A &nbsp;
<a href="javascript:;" title="{$tip}"
   onclick="PlayListingProductSearchHandlerObj.openPopUp(1,'{$productTitle}',{$lpId})">
    <img src="{$iconSrc}" alt="" width="16" height="16">
</a>
HTML;
        }
...
N/A &nbsp;
<a href="javascript:;" title="{$tip}"
   onclick="PlayListingProductSearchHandlerObj.openPopUp(0,'{$productTitle}',{$lpId});">
    <img src="{$iconSrc}" alt="" width="16" height="16">
</a>
HTML;
    }
    ...
    private function getGeneralIdColumnValueNotEmptyGeneralId($row)
    {
        ...
        $text .= <<<HTML
<a href="javascript:;" onclick="PlayListingProductSearchHandlerObj.showUnmapFromGeneralIdPrompt({$id});" title="{$tip}">
...
HTML;
    ...
    {
        return $this->getUrl('*/adminhtml_play_listing/viewGrid', array('_current'=>true));
    }
