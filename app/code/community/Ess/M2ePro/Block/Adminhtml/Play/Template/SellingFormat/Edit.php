...
class Ess_M2ePro_Block_Adminhtml_Play_Template_SellingFormat_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_play_template_sellingFormat';
        $this->_mode = 'edit';
        //------------------------------
        ...
        if (Mage::helper('M2ePro')->getGlobalValue('temp_data')
            ...
            $this->_addButton('duplicate', array(
                ...
                'onclick' => 'PlayTemplateSellingFormatHandlerObj.duplicate_click(\'play-template-sellingFormat\')',
