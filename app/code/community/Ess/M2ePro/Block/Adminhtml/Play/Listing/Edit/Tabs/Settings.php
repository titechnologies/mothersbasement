...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Edit_Tabs_Settings extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/play/listing/tabs/settings.phtml');
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $buttonBlock = $this->getLayout()
            ...
            'onclick' => 'PlayListingSettingsHandlerObj.openWindow(\''
                .$this->getUrl('*/adminhtml_play_template_sellingFormat/new')
                .'\');',
        ...
        $buttonBlock = $this->getLayout()
            ...
            'label'   => Mage::helper('M2ePro')->__('Add New'),
            'onclick' => 'PlayListingSettingsHandlerObj.openWindow(\''
                .$this->getUrl('*/adminhtml_play_template_synchronization/new')
                .'\');',
