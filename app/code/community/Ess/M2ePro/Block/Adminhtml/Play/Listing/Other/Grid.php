...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Other_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    // ####################################
        ...
        $this->addColumn('actions', array(
            ...
            'actions'   => array(
                array(
                    ...
                    'url'       => array('base'=> '*/adminhtml_play_listingOther/unmapToProduct/'),
                    'field'     => 'id',
    ...
    public function callbackColumnProductId($value, $row, $column, $isExport)
    {
        if (empty($value)) {
            ...
            $htmlValue = '&nbsp;<a href="javascript:void(0);"
                                   onclick="PlayListingOtherMapToProductHandlerObj.openPopUp(\''
                         .$productTitle
                         .'\','
                         .(int)$row->getId()
                         .');">'
        ...
        $htmlValue .= '&nbsp&nbsp&nbsp<a href="javascript:void(0);"'
            .' onclick="PlayListingMoveToListingHandlerObj.getGridHtml('
...
<span style="float:right;">
    <a title="{$iconTip}"
       id="lpv_grid_help_icon_open_{$listingOtherId}"
       href="javascript:void(0);"
       onclick="PlayListingItemGridHandlerObj.viewItemHelp('{$listingOtherId}', '{$actionsRows}')">
        <img src="{$iconSrc}" alt="{$iconTip}" />
    </a>
    <a title="{$iconTip}"
       id="lpv_grid_help_icon_close_{$listingOtherId}"
       style="display: none;"
       href="javascript:void(0);"
       onclick="PlayListingItemGridHandlerObj.hideItemHelp('{$listingOtherId}')">
        <img src="{$iconSrc}" alt="{$iconTip}" />
    </a>
</span>
HTML;
...
<script type="text/javascript">
    ...
    if (typeof PlayListingItemGridHandlerObj != 'undefined') {
        PlayListingItemGridHandlerObj.afterInitPage();
    }
...
JAVASCRIPT;
    ...
    {
        return $this->getUrl('*/adminhtml_play_listingOther/grid', array('_current' => true));
    }
