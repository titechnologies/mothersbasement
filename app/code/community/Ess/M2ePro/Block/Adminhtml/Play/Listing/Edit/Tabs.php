...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('settings', array(
            ...
            'content' => $this->getLayout()
                ->createBlock('M2ePro/adminhtml_play_listing_edit_tabs_settings')
                ->toHtml(),
        ));
        ...
        $this->addTab('channel', array(
            ...
            'content' => $this->getLayout()
                ->createBlock('M2ePro/adminhtml_play_listing_edit_tabs_channelSettings')
                ->toHtml(),
        ));
        ...
        $this->addTab('products_filter', array(
            ...
            'content' => $this->getLayout()
                ->createBlock('M2ePro/adminhtml_play_listing_edit_tabs_ProductsFilter')
                ->toHtml(),
        ));
