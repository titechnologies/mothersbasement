...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        // Set template
        //------------------------------
        $this->setTemplate('M2ePro/listing/product/grid.phtml');
        //------------------------------
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('attributes', array(
            'label' => '&nbsp;&nbsp;&nbsp;&nbsp;',
            'url'   => $this->getUrl('*/adminhtml_play_listing/massStatus', array('_current'=>true)),
        ));
        //--------------------------------
    ...
    {
        return $this->getUrl('*/adminhtml_play_listing/productGrid', array('_current'=>true));
    }
...
STYLE;
        ...
        $ruleData = Mage::helper('M2ePro')->getSessionValue(Mage::helper('M2ePro')->getGlobalValue('rule_prefix'));
        $isShowRuleBlock = json_encode(!empty($ruleData));
        ...
        $showAdvancedFilterButtonText = Mage::helper('M2ePro')->__('Show Advanced Filter');
        $hideAdvancedFilterButtonText = Mage::helper('M2ePro')->__('Hide Advanced Filter');

        $createListingUrl = $this->getUrl(
            '*/adminhtml_play_listing/createListing'
        );
        $getProductsUrl = $this->getUrl(
            '*/adminhtml_play_listing/getProductsFromCategories'
        );
        $addProductsUrl = $this->getUrl(
            '*/adminhtml_play_listing/addProducts'
        );
...
JAVASCRIPT;
    ...
    {
        $this->setChild('advanced_filter_button',
        ...
        $this->setChild(
            'advanced_filter_block', $this->getLayout()->createBlock('M2ePro/adminhtml_listing_product_rule')
        );
    ...
    public function getAdvancedFilterBlockHtml()
    {
        return $this->getChildHtml('advanced_filter_block');
    }
