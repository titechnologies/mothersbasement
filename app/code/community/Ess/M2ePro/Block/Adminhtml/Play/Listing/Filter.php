...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Filter extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/play/listing/filter.phtml');
    }
    ...
    protected function makeCutUrlForTemplate($templateUrlParamName)
    {
        ...
        $params['tab'] = Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_PLAY;
