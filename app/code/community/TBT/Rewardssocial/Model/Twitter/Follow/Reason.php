 ...
 */
class TBT_Rewardssocial_Model_Twitter_Follow_Reason extends TBT_Rewards_Model_Transfer_Reason_Abstract
{
    const REASON_TYPE_ID = 34;
    ...
    public function getDistributionReasons() {
        return array(self::REASON_TYPE_ID => $this->_getHelper()->__('Customer followed us on Twitter'));
    }
