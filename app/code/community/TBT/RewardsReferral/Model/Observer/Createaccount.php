...
////////////////////////////////////////////////////////////////////////////////////////// #1648 
			...
			*/
				if(Mage::getSingleton('checkout/session')->getQuote()->getExcellenceLike()){
					$data[$code_field] = Mage::getSingleton('checkout/session')->getQuote()->getExcellenceLike(); //getting referrel email id
                }else if (Mage::helper('rewardsref/code')->getReferral()) {
                    $data[$code_field] = Mage::helper('rewardsref/code')->getReferral();
                } else {
                    $data[$code_field] = '';
                    //throw new Exception("Customer signup was detected with data, but the '{$code_field}' field was not detected.", 1);
