...
class TBT_Rewards_Model_Catalogrule_Rule extends Mage_CatalogRule_Model_Rule implements TBT_Rewards_Model_Migration_Importable {
    ...
    /**
     * Apply all catalog redemption rules, invalidate related cache.
     * Mimics Mage_CatalogRule_Model_Rule::applyAll() but for points redemption rules.
     *
     * @return self
     */
    public function applyAllRedemptionRules()
    {
        //$this->getResourceCollection()->walk(array($this->_getResource(), 'updateRuleProductData'));
        $this->_getResource()->applyAllRedemptionRulesForDateRange();
