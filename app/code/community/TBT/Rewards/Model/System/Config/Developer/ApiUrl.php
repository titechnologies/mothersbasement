...
class TBT_Rewards_Model_System_Config_Developer_ApiUrl extends Mage_Core_Model_Config_Data
{
    ...
    /**
     * If admin changes API URL to '', we'll reset this to default one in config.xml by deleting DB config
     *
     * @return
     */
    protected function _afterSave()
    {
        ...
        if ($this->getValue() == '') {
            Mage::getModel('core/config')->deleteConfig(TBT_Rewards_Model_Platform_Instance::CONFIG_API_URL);
        }
