...
/**
 * Used to render the Developer/ApiKey field on the Config page using a non-default config path
 * @category   TBT
 * @package    TBT_Rewards
 * @author     Sweet Tooth Team <contact@sweettoothhq.com>
 */
class TBT_Rewards_Block_System_Config_Developer_ApiKey extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * Renders the element into HTML, using the API Key as the value to render
