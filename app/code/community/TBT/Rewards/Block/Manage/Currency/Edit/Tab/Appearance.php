...
class TBT_Rewards_Block_Manage_Currency_Edit_Tab_Appearance extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "21555798", "Points Currency Appearance" );
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($image_field, "21626343", "Points Currency Section - Image Path" );
