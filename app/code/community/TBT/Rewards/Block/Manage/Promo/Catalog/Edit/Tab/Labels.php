...
class TBT_Rewards_Block_Manage_Promo_Catalog_Edit_Tab_Labels extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "21644438", "Catalog Spending Rule: Default Label" );
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "21644438", "Catalog Spending Rule: Store View Specific Labels" );
