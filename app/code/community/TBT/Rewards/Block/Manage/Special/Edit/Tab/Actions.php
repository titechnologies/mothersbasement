...
class TBT_Rewards_Block_Manage_Special_Edit_Tab_Actions extends Mage_Adminhtml_Block_Widget_Form {
	protected function _prepareForm() {
		...
		// Dispatch event 
		Mage::dispatchEvent( 'rewards_block_manage_actions_setup_behaviorrule_before', array(
            'actions_block' => $this,
		    'rule'	        => $model,
		    'form'			=> $form
        ) );
	    ...
	    Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "21555758", "Customer Behavior Rule - Actions" );
	    ...
	    Mage::getSingleton('rewards/wikihints')->addWikiHint($isOnholdEnabledField, "21555758", "Customer Behavior Rule - Actions - Transfer On-hold Time" );
		...
		// Dispatch event 
		Mage::dispatchEvent( 'rewards_block_manage_actions_setup_behaviorrule_after', array(
            'actions_block' => $this,
		    'rule'	        => $model,
		    'form'			=> $form
        ) );
